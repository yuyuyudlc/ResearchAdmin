...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/documents/home": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "列表范围：mine/recent/favorite",
                        "name": "scope",
                        "in": "query",
                        "required": true
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.createACLRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/documents/{documentId}/acl/{aclId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "ACL 更新参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateACLRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/documents/{documentId}/body": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "正文类型（yjs_state/pdf/word/video）",
                        "name": "X-Body-Type",
                        "in": "header"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.moveDocumentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/documents/{documentId}/my-permission": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.memberRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.createACLRequest": {
            ...
            "properties": {
                ...
                "subjectType": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.ACLSubjectType"
                        }
                    ],
                    "example": "user"
                }
        ...
        "handler.memberRequest": {
            ...
            "properties": {
                "role": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.WorkspaceMemberRole"
                        }
                    ],
                    "example": "member"
                },
        ...
        "handler.updateWorkspaceRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/domain.WorkspaceStatus"
                }
            }
        },
        "response.Body": {
