...
func main() {
	...
	documentService := service.NewDocumentService(workspaceRepo, workspaceMemberRepo, documentRepo, documentAccessRepo, documentFavoriteRepo, docACLRepo, userRepo, bodyRepo)
